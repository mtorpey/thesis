...
\begin{lemma}
  ...
  \begin{proof}
    ...
    certainly have $\mu \mathrel\lambda_i \widehat\mu$ and
    $\nu \mathrel\lambda_i \widehat\nu$.  Observe that the product
    $\widehat\mu\widehat\nu$ has the kernel of $\widehat\mu$ and the cokernel
    of $\widehat\nu$.  Hence
    $\mu \mathrel\lambda_i \widehat\mu
    \mathrel\rho_i \widehat\mu\widehat\nu
    \mathrel\lambda_i \widehat\nu
    \mathrel\lambda_i \nu$,
