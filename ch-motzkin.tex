...
\begin{lemma}
  ...
  \begin{proof}
    ...
    First, assume (a) holds.  We will show that upper or lower block in $\gamma$
    can be split into singletons to obtain a bipartition which is
    ...
    and observe that $\tau\alpha\gamma = \gamma$ but $\tau\beta\gamma$ is equal
    ...
    can be applied to split all lower blocks.  Hence, as in (a), any two
    bipartitions of rank $0$ are $\sigma$-related in case (b).
