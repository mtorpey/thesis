...
paper also considers other diagram monoids: the bipartition monoid $\Prt_n$ and
several of its other submonoids.  Though these monoids are not the subject of
this chapter, their congruence lattices are closely related to that of $\Mot_n$,
and they use much of the preliminary theory described in Section
...
\subsection{Retractable IN-pairs}
\label{sec:in-pairs}
...
and liftable congruence $\sigma$ a relation $\zeta_{I,N,\sigma}$ defined as
follows:
$$\zeta_{I,N,\sigma} = \zeta_{I,\sigma} \cup
\{(sxt,syt) \in J \times J : x,y \in N \text{~and~} s,t \in S^1\},$$ where $J$
is the $\JJ$-class containing $N$.  It turns out that this relation is a
congruence on $S$ \cite[Proposition 3.22]{ourpaper}.
