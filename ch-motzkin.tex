...
\nomenclature[L0]{$\LL^{I_0}$}{Green's $\LL$-relation retricted to the ideal $I_0$}
\nomenclature[R0]{$\RR^{I_0}$}{Green's $\RR$-relation retricted to the ideal $I_0$}
...
% mu1, lam1, rho1, R1,
% R2 ... Rn
We now have four liftable congruences $\{\Delta_{I_0}, \lL^{I_0}, \rR^{I_0}, \nabla_{I_0}\}$ and
