...
\begin{lemma}
  ...
  \begin{proof}
    ...
    so we now only need to prove that $R_k \subseteq \sigma$.
    ...
    $j_1 < \ldots < j_k$; since $\alpha$ is planar, the transversals must be
    ...
    \item $\alpha$ and $\beta$ have precisely the same transversals
      ...
      $(a,b) \in \ker\alpha \setminus \ker\beta$ with $a < b$;
    \item there exists a transversal $\{i,j'\}$ of $\alpha$ that is not a
      transversal of $\beta$.
    \end{enumerate}
