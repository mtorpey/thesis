...
monoid $\I_n$, and the symmetric group $\Sym_n$.
...
relations very simply in terms of domain, codomain, kernel, cokernel, and rank.
The result is taken from \cite{fitzgerald_2011}.
