...
\nomenclature[<=]{$\subseteq$}{Subset containment (possibly equal)}
\nomenclature[<]{$\subset$}{Strict subset containment (not equal)}
...
\begin{definition}
  ...
  \begin{itemize}
  \item A block of $\alpha$ is a \textbf{transversal} if it contains points from
    both $\mathbf{n}$ and $\mathbf{n}'$;
    \index{transversal}
