...
\ref{sec:intro-presentations}, \ref{sec:intro-elements}). % TODO
...
be used later to define certain semigroups, or properties of semigroups.
...
\begin{definition}
  ...
  \in S$ has an inverse $x^{-1} \in S$ such that $xx^{-1}x=x$. %TODO: correct
\end{definition}
...
the \textbf{degree} of the transformation. \index{degree} A transformation
...
\begin{figure}[h]
  ...
  \begin{tikzpicture}
    ...
    \node[monoid] (d0) at ( 0, 2) {$\mathcal{D}_n$};
    \node[monoid] (id) at ( 0, 0.5) {$\{\id_n\}$};
