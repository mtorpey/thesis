...
pairs in a congruence.  However, when paired with the fast generating pairs code
in libsemigroups \cite{libsemigroups} (as described in Chapter \ref{chap:pairs})
it can give results about small semigroups in a reasonable amount of time.
